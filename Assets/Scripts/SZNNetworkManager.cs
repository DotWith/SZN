...
{
    public class SZNNetworkManager : NetworkManager
    {
        [Header("Maps")]
        ...
        public GameObject FindItem(string id) => spawnPrefabs.Find(i => i.GetComponent<BasicItem>().itemInfo.id == id);
        ...
        public SZNNetworkRoomPlayer roomPlayerPrefab;
        ...
        public List<SZNNetworkRoomPlayer> roomSlots = new List<SZNNetworkRoomPlayer>();
        ...
        public void ReadyStatusChanged()
        {
            ...
            foreach (SZNNetworkRoomPlayer item in roomSlots)
            {
                if (item != null)
                {
                    CurrentPlayers++;
        ...
        public override void OnServerReady(NetworkConnectionToClient conn)
        {
            ...
            if (conn != null && conn.identity != null)
            {
                ...
                if (roomPlayer != null && roomPlayer.GetComponent<SZNNetworkRoomPlayer>() != null)
        ...
        /// <para>If all of the players are ready, then the server switches from the RoomScene to the PlayScene, essentially starting the game. This is called automatically in response to SZNNetworkRoomPlayer.CmdChangeReadyState.</para>
        /// </summary>
        public void CheckReadyToBegin()
        {
            ...
            int numberOfReadyPlayers = NetworkServer.connections.Count(conn => conn.Value != null && conn.Value.identity.gameObject.GetComponent<SZNNetworkRoomPlayer>().readyToBegin);
        ...
        {
            OnRoomClientEnter();
            foreach (SZNNetworkRoomPlayer player in roomSlots)
                if (player != null)
                {
        ...
        public override void OnServerDisconnect(NetworkConnectionToClient conn)
        {
            ...
            {
                SZNNetworkRoomPlayer roomPlayer = conn.identity.GetComponent<SZNNetworkRoomPlayer>();
                ...
                {
                    roomPlayer = clientOwnedObject.GetComponent<SZNNetworkRoomPlayer>();
                    if (roomPlayer != null)
                        roomSlots.Remove(roomPlayer);
                }
            }
            ...
            {
                if (player != null)
                    player.GetComponent<SZNNetworkRoomPlayer>().readyToBegin = false;
            }
        ...
        public override void ServerChangeScene(string newSceneName)
        {
            ...
            {
                foreach (SZNNetworkRoomPlayer roomPlayer in roomSlots)
                {
                    if (roomPlayer == null)
                        continue;
                    ...
                    if (NetworkServer.active)
                    {
                        ...
                        roomPlayer.GetComponent<SZNNetworkRoomPlayer>().readyToBegin = false;
