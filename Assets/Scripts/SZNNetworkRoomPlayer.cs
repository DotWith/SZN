...
{
    public class SZNNetworkRoomPlayer : NetworkBehaviour
    {
        /// <summary>
        ...
        public void Start()
        {
            if (NetworkManager.singleton is SZNNetworkManager room)
            {
                // NetworkRoomPlayer object must be set to DontDestroyOnLoad along with SZNNetworkManager
            ...
            else Debug.LogError("RoomPlayer could not find a SZNNetworkManager. The RoomPlayer requires a SZNNetworkManager object to function. Make sure that there is one in the scene.");
        }

        public virtual void OnDisable()
        {
            if (NetworkClient.active && NetworkManager.singleton is SZNNetworkManager room)
            {
        ...
        public void CmdChangeReadyState(bool readyState)
        {
            ...
            SZNNetworkManager room = NetworkManager.singleton as SZNNetworkManager;
            if (room != null)
            {
